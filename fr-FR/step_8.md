...
Si tu suis le parcours [Introduction à micro:bit](https://projects.raspberrypi.org/fr-FR/raspberrypi/microbit-intro), tu peux passer au projet [Jeu festif](https://projects.raspberrypi.org/fr-FR/projects/party-game). Dans ce projet, tu créeras une version de ton jeu de société préféré pour jouer avec tes ami·e·s et ta famille.
